...
/**
 * Pruebas para EmailNotificationService cubriendo notificaciones de creación, actualización y manejo de errores de template.
 */
...
class EmailNotificationServiceTest {
  ...
  @Test
  @DisplayName("notifyUserCreated() invoca el puerto con el email y asunto de bienvenida correctos")
