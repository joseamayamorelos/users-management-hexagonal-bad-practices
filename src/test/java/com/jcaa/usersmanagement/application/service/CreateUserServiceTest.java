...
@DisplayName("Application Service: CreateUserService - Pruebas de lógica de creación")
...
class CreateUserServiceTest {
  ...
  @Test
  @DisplayName("Debería guardar el usuario y enviar notificación cuando el email es nuevo")
  ...
  @Test
  @DisplayName("Debería lanzar UserAlreadyExistsException cuando el email ya está registrado")
  ...
  @Test
  @DisplayName("Debería lanzar ConstraintViolationException cuando el comando es inválido")
